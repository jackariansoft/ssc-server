	...
	<main role="main" class="container-fluid">
		...
		<div class="row"
			...
			<div class="col-lg-12"
				...
				<div id="dg"
					style="width: 100%; height: 800px; margin-left: 0px; margin-right: 0px"></div>
			</div>
		</div>
		...
		<div id="tb" style="padding: 2px 5px;">			
			<a href="javascript:void(0)" class="easyui-linkbutton"
				...
				onclick="aggiornaStatoOrdini()">Salva Modifiche</a> 
				<a	href="javascript:void(0)" class="easyui-linkbutton"
				data-options="iconCls:'icon-undo',plain:true" onclick="reject()">Reset	Modifche</a>
				 
				<a href="javascript:void(0)" class="easyui-linkbutton"
				data-options="iconCls:'icon-reload',plain:true"
				onclick="deseleziona()">Deseleziona</a> 
				<input		class="easyui-checkbox" name="enableSelection" value="abilita"
				checked="true" width="150" labelWidth="120" title="Se...."
				label="Abilita Selezione"> 
		...
		<script
			src="<%= request.getContextPath()%>/public/js/resource/my.window.js?v=23"></script>
		<script
			src="<%= request.getContextPath()%>/public/js/resource/resource_utils.js?v=47"></script>
		<script
			src="<%= request.getContextPath()%>/public/js/resource/resource.js?v=68"></script>
		<script
