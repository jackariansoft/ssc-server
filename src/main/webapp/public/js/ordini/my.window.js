...
(function ($) {
    ...
    function getDataGrid(target) {
        var opts = $.data(target, 'window').options;
        return opts.rows;

    }
    function setDataGrid(target, rows) {
        var opts = $.data(target, 'window').options;
        opts.rows = rows;
    }
    ...
    $.fn.window.methods = {
        ...
        setGridObject: function (jq, param) {
            return jq.each(function () {
                console.log(param);
                setDataGrid(this, param);
            });
        },
        getDataForGrid: function (jq, table) {
            return jq.each(function () {
                var rows_ = getDataGrid(this);
                table.datagrid('loadData', rows_);
                }
            );
        },
        getDataRows: function (jq, table) {
            return jq.each(function () {
                 return getDataGrid(this);
