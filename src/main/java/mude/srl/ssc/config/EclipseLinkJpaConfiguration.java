...
import mude.srl.ssc.ServletInitializer;
import static mude.srl.ssc.ServletInitializer.DATA_SOURCE;
...
//    }
    ...
    public LocalContainerEntityManagerFactoryBean magEntityManager() {
        ...
        try {
            ...
            etm.setPackagesToScan(new String[]{ServletInitializer.PACKAGE_MODEL});
            //etm.setPersistenceUnitName(ServletInitializer.PERSISTENCE_UNIT);
