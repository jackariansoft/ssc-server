...
import mude.srl.ssc.modbus.msg.WriteCoilRequest;
...
public class DIDOTest {
	...
	private static void printUsage() {
		System.out
				.println("java net.wimpi.modbus.cmd.DIDOTest <address{:<port>} [String]> <register d_in [int16]> <register d_out [int16]>");
	}// printUsage
