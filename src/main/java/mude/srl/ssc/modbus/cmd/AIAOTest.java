...
import mude.srl.ssc.modbus.io.ModbusTransaction;
import mude.srl.ssc.modbus.msg.ModbusRequest;
import mude.srl.ssc.modbus.msg.ReadInputRegistersRequest;
import mude.srl.ssc.modbus.msg.ReadInputRegistersResponse;
import mude.srl.ssc.modbus.msg.WriteSingleRegisterRequest;
...
public class AIAOTest {
	...
	private static void printUsage() {
		System.out
				.println("java net.wimpi.modbus.cmd.AIAOTest <address{:<port>} [String]> <register a_in [int16]> <register a_out [int16]>");
	}// printUsage
