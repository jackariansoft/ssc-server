...
/**
 * Class that implements a simple commandline tool for writing to an analog
 * output.
 * <p>
...
public class AOTest {
	...
	private static void printUsage() {
		System.out
				.println("java net.wimpi.modbus.cmd.AOTest <address{:<port>} [String]> <register [int]> <value [int]> {<repeat [int]>}");
	}// printUsage
