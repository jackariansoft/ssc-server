...
import mude.srl.ssc.modbus.net.UDPMasterConnection;
import mude.srl.ssc.modbus.net.UDPTerminal;
import mude.srl.ssc.modbus.util.AtomicCounter;
import mude.srl.ssc.modbus.util.Mutex;

/**
 * Class implementing the <tt>ModbusTransaction</tt> interface for the UDP
 * transport mechanism.
 * 
...
public class ModbusUDPTransaction implements ModbusTransaction {
	...
	/**
	 * Constructs a new <tt>ModbusUDPTransaction</tt> instance.
	 */
	public ModbusUDPTransaction() {
	}// constructor

	/**
	 * Constructs a new <tt>ModbusUDPTransaction</tt> instance with a given
	...
	/**
	 * Constructs a new <tt>ModbusUDPTransaction</tt> instance with a given
	 * <tt>UDPTerminal</tt> to be used for transactions.
	 * <p/>
	 * 
	 * @param terminal
	...
	/**
	 * Constructs a new <tt>ModbusUDPTransaction</tt> instance with a given
	 * <tt>ModbusUDPConnection</tt> to be used for transactions.
	 * <p/>
	 * 
	 * @param con
	 *            a <tt>ModbusUDPConnection</tt> instance.
	 */
	...
	/**
	 * Sets the terminal on which this <tt>ModbusTransaction</tt> should be
	 * executed.
	 * <p>
	 * 
	 * @param terminal
	 *            a <tt>UDPSlaveTerminal</tt>.
	 */
	 ...
	 *             if this transaction cannot be asserted as executable.
	 */
