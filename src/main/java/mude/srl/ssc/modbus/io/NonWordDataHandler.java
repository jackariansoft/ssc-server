...
public interface NonWordDataHandler {
	 ...
	 * @param count
	 *            to sepcify the amount of bytes as <tt>int</tt>.
	 * 
	 * @throws IOException
	 *             if I/O fails.
	 * @throws EOFException
	 ...
	 * This method is called by a <tt>ReadMultipleRegistersRequest</tt> instance
	 * when finshed with reading, for creating a response.
	 * 
	 * @param reference
	 *            to specify the offset as <tt>int</tt>.
	 * @param count
