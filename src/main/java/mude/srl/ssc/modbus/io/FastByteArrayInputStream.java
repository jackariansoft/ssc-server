...
/**
 * This class is a clean room implementation of the ByteArrayInputStream, with
...
public class FastByteArrayInputStream extends InputStream {
	...
	/**
	 * Creates a new <tt>FastByteArrayInputStream</tt> instance that allows to
	 ...
	 * method may skip over some smaller number of bytes. The actual number of
	 * bytes skipped is returned, or a number <=0 if none was skipped.
	 * <p/>
	...
	/**
	 * Marks the current position in this <tt>FastByteArrayInputStream</tt>. A
	 * subsequent call to{@link #reset()} will re-postition this
	 * <tt>FastByteArrayInputStream</tt> at the last marked position so that
	...
	/**
	 * Tests if this <tt>FastByteArrayInputStream</tt> supports the mark and
	 * reset methods.
	 * 
	...
	/**
	 * Re-positions this stream to the position at the time the mark method was
	 * last called this <tt>FastByteArrayInputStream</tt>.
	 * 
	 * @throws IOException
