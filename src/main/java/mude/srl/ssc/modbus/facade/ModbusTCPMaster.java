...
public class ModbusTCPMaster {
	...
	/**
	 * Sets the flag that specifies whether to maintain a constant connection or
	...
	/**
	 * Tests if a constant connection is maintained or if a new connection is
	 * established for every transaction.
	 * 
